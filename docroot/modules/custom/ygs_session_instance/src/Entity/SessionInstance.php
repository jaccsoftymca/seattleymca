...
namespace Drupal\ygs_session_instance\Entity;
 ...
 *     "list_builder" = "Drupal\ygs_session_instance\SessionInstanceListBuilder",
 *     "views_data" = "Drupal\ygs_session_instance\Entity\SessionInstanceViewsData",
 *
 *     "form" = {
 *       "default" = "Drupal\ygs_session_instance\Form\SessionInstanceForm",
 *       "add" = "Drupal\ygs_session_instance\Form\SessionInstanceForm",
 *       "edit" = "Drupal\ygs_session_instance\Form\SessionInstanceForm",
 *       "delete" = "Drupal\ygs_session_instance\Form\SessionInstanceDeleteForm",
 *     },
 *     "access" = "Drupal\ygs_session_instance\SessionInstanceAccessControlHandler",
 *     "route_provider" = {
 *       "html" = "Drupal\ygs_session_instance\SessionInstanceHtmlRouteProvider",
 *     },
 *   },
...
class SessionInstance extends ContentEntityBase implements SessionInstanceInterface {
   ...
   * {@inheritdoc}
   */
  public function isActualSession() {
    return (bool) $this->get('actual')->value;
  }
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['actual'] = BaseFieldDefinition::create('boolean')
    ...
    $fields['class_type'] = BaseFieldDefinition::create('string')
