...
interface SessionInstanceInterface extends ContentEntityInterface {
   ...
   *
   * @return \Drupal\ygs_session_instance\Entity\SessionInstanceInterface
  ...
  /**
   * Returns the related session is actual indicator.
   *
   * @return bool
   *   TRUE if the related session is actual.
   */
