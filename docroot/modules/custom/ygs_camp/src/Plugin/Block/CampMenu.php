...
namespace Drupal\ygs_camp\Plugin\Block;
...
use Drupal\node\NodeInterface;
use Drupal\ygs_camp\CampMenuServiceInterface;
...
class CampMenu extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   *
   * @var \Drupal\ygs_camp\CampMenuServiceInterface
   */
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('ygs_camp.menu_handler'),
