...
namespace Drupal\ymca_hours_formatter\Plugin\Field\FieldFormatter;

use Drupal\Core\Field\FieldItemListInterface;
use Drupal\field_collection\Plugin\Field\FieldFormatter\FieldCollectionItemsFormatter;

/**
 * Plugin implementation of the 'ymca_hours_formatter' formatter.
 *
 * @FieldFormatter(
 *   id = "ymca_hours_formatter",
...
class HoursToday extends FieldCollectionItemsFormatter {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    $lazy_hours_placeholder = [
      '#lazy_builder' => [
        'ymca_hours_formatter.hours_today:generateHoursToday',
        $lazy_hours,
      ],
    ...
    $render_array = [
      '#theme' => 'ymca_hours_formatter',
      '#hours' => $lazy_hours_placeholder,
      '#week' => $week,
      '#attached' => [
        'library' => [
          'ymca_hours_formatter/ymca_hours_formatter',
        ],
      ],
    ];
    return $render_array;
