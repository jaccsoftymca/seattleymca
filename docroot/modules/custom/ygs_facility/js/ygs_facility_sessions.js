(function($) {
  ...
  Drupal.behaviors.ygs_facility_sessions = {
    attach: function(context, settings) {
      ...
      $(document)
        ...
        .ajaxSuccess(function(e, xhr, settings) {
          if (settings.data && settings.data.match('form_id')) {
      ...
      $('.ygs-branch-sessions-form').each(function() {
        ...
        form.find('.clear')
          ...
          var path = $('.link-source a').attr('href'),
            location_id = $('.full-schedule-facility').data('location-id');
          $('.full-schedule-facility').attr('href', path.replace('[location]', location_id));
      });
    }
  };
})(jQuery);
