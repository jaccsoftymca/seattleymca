...
$config['technicalcontact_name'] = "FFW";
$config['technicalcontact_email'] = "ffw@seattleymca.org";
// Change these for your installation
$config['secretsalt'] = 'g1W4KZgWCeWh7Af9_gSb9D9HOiNaBdWPvQD-8x0yWpcgNpTBppaHR5VNGQBGvh2k8P8uWa1V8w';
$config['auth.adminpassword'] = '6uxuSpAdrEku';
$config['admin.protectindexpage'] = TRUE;
// Prevent Varnish from interfering with SimpleSAMLphp.
setcookie('NO_CACHE', '1');
if (empty($_ENV['AH_SITE_ENVIRONMENT'])) {
  $creds = $GLOBALS['config']['databases']['default']['default'];
  $config['store.type'] = 'sql';
  $config['store.sql.dsn'] = sprintf('mysql:host=%s;port=%s;dbname=%s', $creds['host'], $creds['port'], $creds['database']);
  $config['store.sql.username'] = $creds['username'];
  $config['store.sql.password'] = $creds['password'];
