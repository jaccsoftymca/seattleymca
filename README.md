...
To install all necessary libraries(MSSQL and etc.) use following:

```sh
vagrant up --provision && vagrant ssh
```

If your VM already up and running:
```sh
vagrant provision
```
...
**Note:**
Please use only this domain for the additional localhost usage: 
**ygs.192.168.56.132.xip.io**
